...
import Orientation from "../../../visualization/orientation";
import ThumbRaiser from "../../../visualization/thumb_raiser";
...
export class VisualizationPageComponent implements OnInit, AfterViewInit, OnDestroy {

  private static thumbRaiser: any;

  ngAfterViewInit(): void {
    this.initialize();
    VisualizationPageComponent.animate();
 }
  ...
  initialize() {
    // Create the game
    VisualizationPageComponent.thumbRaiser = new ThumbRaiser(
      {}, // General Parameters
      {
        enabled: true,
        introductionClips: [
      ...
      {
        view: "fixed",
        initialViewport: new THREE.Vector4(0.0, 1.0, 1.0, 1.0),
      ...
      }, // Fixed view camera parameters
      {
        view: "first-person",
        initialViewport: new THREE.Vector4(0.0, 1.0, 1.0, 1.0),
        initialOrientation: new Orientation(0.0, -1.0),
        orientationMax: new Orientation(180.0, 90.0),
        initialFogDensity: 0.4
      ...
      {
        view: "mini-map",
        initialViewport: new THREE.Vector4(1.0, 0.0, 0.5, 0.3),
  ...
  static animate() {
    requestAnimationFrame(VisualizationPageComponent.animate);
    VisualizationPageComponent.thumbRaiser.update();
  }
