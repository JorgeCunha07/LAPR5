...
@Component({
  selector: 'app-floor-page-update-floor',
  templateUrl: './floor-page-update-floor.component.html',
  styleUrls: ['./floor-page-update-floor.component.scss']
})


export class FloorPageUpdateFloorComponent {
